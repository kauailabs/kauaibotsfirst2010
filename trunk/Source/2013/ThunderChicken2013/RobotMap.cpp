...
void RobotMap::init() {
	...
	double steer_L_F_offset_angle = prefs->GetDouble("F_L_Steer_Offset_Angle", 0.0);
	double steer_L_B_offset_angle = prefs->GetDouble("F_B_Steer_Offset_Angle", 0.0);
	double steer_R_F_offset_angle = prefs->GetDouble("R_F_Steer_Offset_Angle", 0.0);
	double steer_R_B_offset_angle = prefs->GetDouble("R_B_Steer_Offset_Angle", 0.0);	
