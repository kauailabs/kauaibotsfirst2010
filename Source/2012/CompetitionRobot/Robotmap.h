...
#define DRIVE_FRONT_LEFT_EDGEFINDER_CHANNEL 4
#define DRIVE_FRONT_RIGHT_EDGEFINDER_CHANNEL 5
#define DRIVE_REAR_RIGHT_EDGEFINDER_CHANNEL 6
#define DRIVE_REAR_LEFT_EDGEFINDER_CHANNEL 7
#endif
