...
void RobotMap::init() {
	...
	lw->AddActuator("SwerveDrive_L_F", "steer_motor", (Talon*) swerveDriveSystemleft_front_steer_motor);
	
	swerveDriveSystemleft_front_angle_sensor = new AngleSensor(1, 12, 14, 13, steer_L_F_offset_angle);
	lw->AddSensor("SwerveDrive_L_F", "angle_sensor", swerveDriveSystemleft_front_angle_sensor);
	...
	lw->AddActuator("SwerveDrive_L_F", "steer_controller", swerveDriveSystemleft_front_steer);
