...
#include "SetShooterTiltAngleDegrees.h"

SetShooterTiltAngleDegrees::SetShooterTiltAngleDegrees() {
...
bool SetShooterTiltAngleDegrees::IsFinished() {
	return false;
}

// Called once after isFinished returns true
void SetShooterTiltAngleDegrees::End() {
	
}

// Called when another command which requires one or more of the same
// subsystems is scheduled to run
void SetShooterTiltAngleDegrees::Interrupted() {
