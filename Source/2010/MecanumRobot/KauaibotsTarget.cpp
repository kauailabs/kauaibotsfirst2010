...
const double cCameraAngleOfViewDegrees = 40.0; //47.0;		// TODO:  Measure this
...
const double cVertCameraServoRangeDegrees = 80;		// -18 degrees from vertical (tilted backwards)
...
// Method using yPos
double KauaibotsTarget::GetDistanceToTargetFeet()
{
...
double KauaibotsTarget::GetDistanceToTargetFeet2()
{
	double dDistance = ((1/((m_nVertPixelPitchMM*((m_majorRadius * m_nHeight)*2))/cCameraFocalLengthMM))*cTargetOuterDiameterInches)/12;
