...
/**
 * The camera subsystem intializes/configures
 * the camera, and performs detection of whether
 * the goal in front of the robot is "hot" or
 * not.
 * 
 * THIS CODE HAS NOT YET BEEN FLESHED OUT.
 * 
 * NOTE:  This code was copied from
 * the image processing code that is 
 * part of the "2014VisionSampleProject",
 * which can be created from within
 * Netbeans via the Files->New Project...
 * menu item in Netbeans, and selecting
 * the Samples->FRC Java->2014VisionSampleProject.
 */
