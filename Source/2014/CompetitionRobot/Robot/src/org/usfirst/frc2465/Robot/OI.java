...
public class OI {
    ...
    public JoystickButton armMidBtn;
    public JoystickButton armHighBtn;
    ...
    public OI() {
        ...
        armHighBtn = new JoystickButton(driverJoystick, 8);
        armHighBtn.whenPressed(new ArmHigh());
        armMidBtn = new JoystickButton(driverJoystick, 7);
        armMidBtn.whenPressed(new ArmMid());
        armLowBtn = new JoystickButton(driverJoystick, 6);
        armLowBtn.whenPressed(new ArmLow());
        ...
        SmartDashboard.putData("ArmMid", new ArmMid());
