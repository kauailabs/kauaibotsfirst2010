...
public class OI {
    ...
    public JoystickButton testTargetDetectionBtn;
    ...
    public OI() {
        ...
        testTargetDetectionBtn = new JoystickButton(driverJoystick,11);
        boolean timeout = false;
        testTargetDetectionBtn.whileHeld(new WaitForCameraHot(timeout) );
