...
public class Tensioner extends PIDSubsystem {
    ...
    ProximitySensor leftDistance = RobotMap.tensionerLeftDistance; // LargeDistance == Low TEnsion; Small Distance == High Tension
    Relay lock = RobotMap.tensionerLock;  // Forward == Lock ; Off == Unlock
